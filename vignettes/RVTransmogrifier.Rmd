...
```{r eval=FALSE}
plot(data$GSDET$FLEN, data$GSDET$FWT, pch = 19, col=factor(data$GSDET$MISSION))
legend("topleft", pch = 19, legend = unique(factor(data$GSDET$MISSION)), col = unique(factor(data$GSDET$MISSION)))
```
